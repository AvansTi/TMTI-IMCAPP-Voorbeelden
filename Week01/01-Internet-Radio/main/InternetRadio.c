...
static const char* RADIO_ADDRESS = "https://streams.pinguinradio.com/Aardschok192.mp3";
...
void app_main(void)
{
    ...
    audio_element_set_uri(http_stream_reader, RADIO_ADDRESS);
